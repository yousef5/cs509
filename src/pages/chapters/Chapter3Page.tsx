...
import { quiz3 } from "../../utils/quiz3";
import { Explanation3Dialog } from "../../components/Explanation3Dialog";
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-l from-blue-600 to-indigo-700 px-6 py-8 text-white relative">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold mb-1">الشيت الثالث</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className=" w-[600px] grid grid-cols-1  gap-4 items-center justify-center">
          ...
          <Card className="border border-purple-100">
            ...
            <CardContent className="p-3">
              <NetworkingQuizApp title="Chapter 3 Quiz" questions={quiz3} />
            </CardContent>
          </Card>
        </div>
      </div>
